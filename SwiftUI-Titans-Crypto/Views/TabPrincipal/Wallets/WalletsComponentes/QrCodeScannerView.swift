...
struct QrCodeScannerView: UIViewRepresentable {
    ...
    func makeUIView(context _: UIViewRepresentableContext<QrCodeScannerView>) -> QrCodeScannerView.UIViewType {
    ...
    static func dismantleUIView(_ uiView: CameraPreview, coordinator _: ()) {
    ...
    func updateUIView(_ uiView: CameraPreview, context _: UIViewRepresentableContext<QrCodeScannerView>) {
